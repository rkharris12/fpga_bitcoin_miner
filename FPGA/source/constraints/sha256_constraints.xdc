...
create_clock -name {clk_125m} -period 8.00 [get_ports {CLK_125M}]
create_generated_clock -name {clk_hash} [get_pins mmcm_clk_hash/clk_out1]

create_clock -name {clk_avl} -period 20.00 [get_pins {u_soc_wrapper/soc_i/processing_system7_0/inst/PS7_i/FCLKCLK[0]}]
create_generated_clock -name {clk_hash_1} [get_pins {mmcm_clk_hash/inst/mmcm_adv_inst/CLKOUT0}]
...
#create_clock -add -name clk_125m_pin -period 8.00 -waveform {0 4} [get_ports { CLK_125M }];
